...
override PKGDIR = xconfig_Lab9_oversample_NONburst
...
package/%.xdc.inc package/%_xconfig_Lab9_oversample_NONburst.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_Lab9_oversample_NONburst" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,28FP .dlls: Lab9_oversample_NONburst.p28FP

-include package/cfg/Lab9_oversample_NONburst_p28FP.mak
-include package/cfg/Lab9_oversample_NONburst_p28FP.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/Lab9_oversample_NONburst_p28FP.dep
endif
Lab9_oversample_NONburst.p28FP: package/cfg/Lab9_oversample_NONburst_p28FP.xdl
	@


ifeq (,$(wildcard .libraries,28FP))
Lab9_oversample_NONburst.p28FP package/cfg/Lab9_oversample_NONburst_p28FP.c: .libraries,28FP
endif

package/cfg/Lab9_oversample_NONburst_p28FP.c package/cfg/Lab9_oversample_NONburst_p28FP.h package/cfg/Lab9_oversample_NONburst_p28FP.xdl: override _PROG_NAME := Lab9_oversample_NONburst.x28FP
package/cfg/Lab9_oversample_NONburst_p28FP.c: package/cfg/Lab9_oversample_NONburst_p28FP.cfg
package/cfg/Lab9_oversample_NONburst_p28FP.xdc.inc: package/cfg/Lab9_oversample_NONburst_p28FP.xdl
package/cfg/Lab9_oversample_NONburst_p28FP.xdl package/cfg/Lab9_oversample_NONburst_p28FP.c: .interfaces

clean:: clean,28FP
	-$(RM) package/cfg/Lab9_oversample_NONburst_p28FP.cfg
	-$(RM) package/cfg/Lab9_oversample_NONburst_p28FP.dep
	-$(RM) package/cfg/Lab9_oversample_NONburst_p28FP.c
	-$(RM) package/cfg/Lab9_oversample_NONburst_p28FP.xdc.inc

clean,28FP::
	-$(RM) Lab9_oversample_NONburst.p28FP
.executables,28FP .executables: Lab9_oversample_NONburst.x28FP

Lab9_oversample_NONburst.x28FP: |Lab9_oversample_NONburst.p28FP

-include package/cfg/Lab9_oversample_NONburst.x28FP.mak
Lab9_oversample_NONburst.x28FP: package/cfg/Lab9_oversample_NONburst_p28FP.o28FP 
	$(RM) $@
	@$(MSG) lnk28FP $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.C28_float.rootDir)/bin/cl2000 -q -u _c_int00 -z  -o $@ package/cfg/Lab9_oversample_NONburst_p28FP.o28FP   package/cfg/Lab9_oversample_NONburst_p28FP.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.C28_float.rootDir)/lib/libc.a
	
Lab9_oversample_NONburst.x28FP: export C_DIR=
Lab9_oversample_NONburst.x28FP: PATH:=$(ti.targets.C28_float.rootDir)/bin/;$(PATH)
Lab9_oversample_NONburst.x28FP: Path:=$(ti.targets.C28_float.rootDir)/bin/;$(PATH)

Lab9_oversample_NONburst.test test,28FP test: Lab9_oversample_NONburst.x28FP.test

Lab9_oversample_NONburst.x28FP.test:: Lab9_oversample_NONburst.x28FP
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 Lab9_oversample_NONburst.x28FP.test
else
	@$(MSG) running $<  ...
	$(call EXEC.Lab9_oversample_NONburst.x28FP, ) 
endif

clean,28FP::
	-$(RM) $(wildcard .tmp,Lab9_oversample_NONburst.x28FP,*)


clean:: clean,28FP

clean,28FP::
	-$(RM) Lab9_oversample_NONburst.x28FP
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
Lab9_oversample_NONburst_p28FP.o28FP,copy : package/cfg/Lab9_oversample_NONburst_p28FP.o28FP
Lab9_oversample_NONburst_p28FP.s28FP,copy : package/cfg/Lab9_oversample_NONburst_p28FP.s28FP

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_Lab9_oversample_NONburst
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_Lab9_oversample_NONburst.tar.dep
endif
package/rel/xconfig_Lab9_oversample_NONburst/xconfig_Lab9_oversample_NONburst/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_Lab9_oversample_NONburst/xconfig_Lab9_oversample_NONburst/package/package.rel.xml: package/build.cfg
package/rel/xconfig_Lab9_oversample_NONburst/xconfig_Lab9_oversample_NONburst/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_Lab9_oversample_NONburst/xconfig_Lab9_oversample_NONburst/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_Lab9_oversample_NONburst.tar: package/rel/xconfig_Lab9_oversample_NONburst.xdc.inc package/rel/xconfig_Lab9_oversample_NONburst/xconfig_Lab9_oversample_NONburst/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_Lab9_oversample_NONburst.xdc.inc,package/rel/xconfig_Lab9_oversample_NONburst.tar.dep)


release release,xconfig_Lab9_oversample_NONburst: all xconfig_Lab9_oversample_NONburst.tar
clean:: .clean
	-$(RM) xconfig_Lab9_oversample_NONburst.tar
	-$(RM) package/rel/xconfig_Lab9_oversample_NONburst.xdc.inc
	-$(RM) package/rel/xconfig_Lab9_oversample_NONburst.tar.dep
